        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                <div class="px-0 py-4 text-gray-900 dark:text-gray-100">
                    ...
                    <form action="{{route('centrodesalud.store')}}" method="POST">
                        @csrf
                        <div class="bg-emerald-100 shadow-md rounded px-8 pt-6 pb-8 mb-4 flex flex-col">
                            ...
                            <div class="-mx-3 md:flex mb-1">
                                <div class="md:w-1/3 px-3 mb-1 md:mb-0">
                                    ...
                                    <input type="text" name="codigo_cs" id="codigo_cs"  value="{{old('codigo_cs')}}"
                                ...
                                <div class="md:w-2/3 px-3">
                                    ...
                                    <input type="text" name="nombre_cs" id="nombre_cs"  value="{{old('nombre_cs')}}"
                                        class=" w-full bg-emerald-50 text-black border border-lime-900 rounded py-1 px-3 mb-1">
                            ...
                            <div class="-mx-3 md:flex mb-1">
                                    ...
                                    <div>
                                        <select name="idcargos_encs" id="idcargos_encs"
                                            ...
                                            @foreach ($cargos as $item)
                                                <OPTION value="{{$item->idcargos_encs}}" {{old('idcargos_encs')==$item->idcargos_encs?'selected':''}} >{{$item->cargo}}</OPTION>
                                            @endforeach
                                ...
                                <div class="md:w-2/3 px-3 mb-1 md:mb-0">
                                    <label class=" tracking-wide text-black text-xs font-bold mb-2" for="nombre_enc">
                                        Nombre del encargado
                                    </label>
                                    <input type="text" name="nombre_enc" id="nombre_enc"  value="{{old('nombre_enc')}}"
                                        class="w-full bg-emerald-50 text-black border border-lime-900 rounded py-1 px-3 mb-1">
                            ...
                            <div class="-mx-3 md:flex mb-1">
                                ...
                                <div class="md:w-2/3 px-3 mb-1 md:mb-0 ">
                                    <label for="telefonos" class=" tracking-wide text-black text-xs font-bold mb-2">
                                        {{__('Phone')}}s
                                    </label>
                                    <input type="text" name="telefonos" id="telefonos" value="{{old('telefonos')}}" class="w-full bg-emerald-50 text-black border border-lime-900 rounded py-1 px-3 mb-1">
